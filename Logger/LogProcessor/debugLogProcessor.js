...
exports.DebugLogProcessor = void 0;
var logProcessor_1 = require("./logProcessor");
var DebugLogProcessor = /** @class */ (function (_super) {
    __extends(DebugLogProcessor, _super);
    function DebugLogProcessor(nextLog) {
        return _super.call(this, nextLog) || this;
    }
    DebugLogProcessor.prototype.log = function (logLevel, message) {
        if (logLevel === logProcessor_1.LogProcessor.DEBUG) {
...
exports.DebugLogProcessor = DebugLogProcessor;
